<!--**********************************
        ...
        ***********************************-->
		<div class="nav-header">
            <a href="{{url('./dashboard/main')}}" class="brand-logo">
					...
					<div class="tab-pane fade active show" id="chat" role="tabpanel">
						<div class="card mb-sm-3 mb-md-0 contacts_card dlab-chat-user-box">
							<div class="card-header chat-list-header text-center">
								...
								<div>
									<h6 class="mb-1">Lista de Conversas</h6>
										...
										<div class="card-body px-0">
											<div class="px-3">
												<div class="input-group search-area w-100">
													...
													<h6 class="my-2 mt-3">Pesquisado Recentemente:</h6>
											</div>
										...
										<div class="card mb-0">
											<div class="card-header p-3">
												<ul class="d-flex align-items-center">
													...
													<li class="ms-2">
														<h4 class="mb-0">{{ Auth::user() ? Auth::user()->name : 'Utilizador' }}</h4>
														<span>{{ Auth::user() ? Auth::user()->email : 'Admin' }}</span>
													</li>
												</ul>
												...
												<a href="javascript:void(0);" class="dropdown-item ai-icon ">
													<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
														<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
															...
															<path d="M3.00065168,20.1992055 C3.38825852,15.4431929 7.26191235,13 11.9833413,13 C16.7712164,13 20.7048837,15.2931929 20.9979143,20.2 C21.0095879,20.3954741 20.9979143,21 20.2466999,21 C16.541124,21 11.0347247,21 3.72750223,21 C3.47671215,21 2.97953825,20.45918 3.00065168,20.1992055 Z" fill="var(--primary)" fill-rule="nonzero"/>
														</g>
													</svg>
