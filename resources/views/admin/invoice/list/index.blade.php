                                                ...
                                                <tr>
													...
													<div class="dropdown custom-dropdown d-inline-block">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                <a class="dropdown-item" href="{{ route('invoice.show', $invoiceItem->id) }}">Ver Detalhes</a>
                                                                <a class="dropdown-item" href="{{ route('invoice.edit', $invoiceItem->id) }}">Editar</a>
                                                                <form action="{{ route('invoice.destroy', $invoiceItem->id) }}" method="POST" onsubmit="return confirm('Tem a certeza que deseja eliminar esta fatura?');">
                                                                    @csrf
                                                                    @method('DELETE')
