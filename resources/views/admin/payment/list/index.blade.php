                                                ...
                                                <tr>
													...
													<div class="dropdown custom-dropdown d-inline-block">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                <a class="dropdown-item" href="{{ route('payment.show', $paymentItem->id) }}">Ver Detalhes</a>
                                                                @if($paymentItem->invoice)
                                                                    <a class="dropdown-item" href="{{ route('invoice.show', $paymentItem->invoice->id) }}">Ver Fatura</a>
                                                                @else
                                                                    <a class="dropdown-item" href="{{ route('invoice.create', ['payment_id' => $paymentItem->id, 'enrollment_id' => $paymentItem->enrollment_id]) }}">Gerar Fatura</a>
                                                                @endif
                                                                <a class="dropdown-item" href="{{ route('payment.edit', $paymentItem->id) }}">Editar</a>
                                                                <form action="{{ route('payment.destroy', $paymentItem->id) }}" method="POST" onsubmit="return confirm('Tem a certeza que deseja eliminar este pagamento?');">
                                                                    @csrf
                                                                    @method('DELETE')
													...
													<ul class="tbl-action">
														<li>	
															...
															<div class="dropdown custom-dropdown ">
																<div class="btn sharp tp-btn " data-bs-toggle="dropdown" data-bs-boundary="viewport">
