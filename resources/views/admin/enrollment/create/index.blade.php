            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4 class="card-title mb-0">Adicionar Nova Inscrição</h4>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-sm-6">
                                    {{-- Campo de Busca do Estudante usando datalist --}}
                                    <div class="mb-3">
                                        <label for="student_search" class="form-label text-primary">Pesquisar Estudante <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="student_search" list="students_list" placeholder="Digite o nome ou BI do estudante..." autocomplete="off" required>
                                        ...
                                        <small class="text-muted">Selecione uma opção na lista para preencher automaticamente.</small>
                                    </div>

                                    {{-- Data da Inscrição --}}
                                    <div class="mb-3">
                                        <label for="date" class="form-label text-primary">Data da Inscrição <span class="text-danger">*</span></label>
                                        <input type="datetime-local" class="form-control" id="date" name="date" value="{{ old('date', date('Y-m-d\TH:i')) }}" required>
                                    </div>
                                </div>

                                <div class="col-xl-6 col-sm-6">
                                    {{-- Campo de Busca do Curso usando datalist --}}
                                    <div class="mb-3">
                                        <label for="course_search" class="form-label text-primary">Pesquisar Curso <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="course_search" list="courses_list" placeholder="Digite o nome do curso..." autocomplete="off" required>
                                        ...
                                        <small class="text-muted">Selecione um curso para preenchimento automático.</small>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select id="status" name="status" class="default-select wide form-control" required>
                                            <option value="1" {{ old('status', '1') == '1' ? 'selected' : '' }}>Ativa / Confirmada</option>
                                            <option value="0" {{ old('status') === '0' ? 'selected' : '' }}>Pendente / Inativa</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
