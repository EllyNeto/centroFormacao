                                                ...
                                                <tr>
													...
													<div class="dropdown custom-dropdown d-inline-block">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                <a class="dropdown-item" href="{{ route('student.show', $studentItem->id) }}">Ver Detalhes</a>
                                                                <a class="dropdown-item" href="{{ route('student.edit', $studentItem->id) }}">Editar</a>
                                                                <form action="{{ route('student.destroy', $studentItem->id) }}" method="POST" onsubmit="return confirm('Tem a certeza que deseja eliminar este Formando?');">
                                                                    @csrf
                                                                    @method('DELETE')
