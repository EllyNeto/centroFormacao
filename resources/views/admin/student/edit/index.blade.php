...
@section('title', 'Editar Formando')

{{-- Conteúdo principal da página de edição de Formando --}}
@section('content')
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4 class="card-title mb-0">Editar Formando: {{ $student->name }}</h4>
                        <a href="{{ route('student.index') }}" class="btn btn-secondary btn-sm">
                            <i class="fa fa-arrow-left me-1"></i> Voltar à Listagem
                        </a>
                    </div>

                    {{-- Formulário de submissão para atualizar os dados do Formando enviando por PUT --}}
                    <form action="{{ route('student.update', $student->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                {{-- Coluna Esquerda: Fotografia do Formando --}}
                        ...
                        <div class="card-footer text-end">
                            ...
                            <button type="submit" class="btn btn-primary">Atualizar Formando</button>
                        </div>
                    </form>
                </div>
            </div>
