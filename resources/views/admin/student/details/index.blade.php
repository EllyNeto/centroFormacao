								...
								<div class="row mt-4">
									...
									<div class="col-xl-3 col-sm-6 mb-3">
										<ul class="student-details">
											...
											<li>
												<span>Género:</span>
												<h5 class="mb-0">{{ $student->gender ?? 'N/D' }}</h5>
											</li>
										</ul>
									</div>
...
<div class="card h-auto">
							...
							<div class="card-body p-0">
								<div class="table-responsive basic-tbl">
									<table id="example-payment" class="table display dataTable w-100" style="min-width: 845px">
										<thead>
											<tr>
								...
								<div class="card h-auto schedule-card">
									<div class="card-body">
										...
										<div class="d-flex align-items-center justify-content-between">
											...
											<div>
												<img src="{{ asset('images/avatar/1.jpg') }}" class="avatar avatar-lg" alt="">
											</div>
										</div>
									</div>
								</div>
								...
								<div class="card h-auto schedule-card-3">
									<div class="card-body">
										...
										<div class="d-flex align-items-center justify-content-between">
											...
											<div>
												<img src="{{ asset('images/avatar/4.jpg') }}" class="avatar avatar-lg" alt="">
											</div>
										</div>
									</div>
								</div>
