                                                ...
                                                <tr>
													...
													<div class="dropdown custom-dropdown d-inline-block">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                <a class="dropdown-item" href="{{ route('teacher.show', $teacherItem->id) }}">Ver Detalhes</a>
                                                                <a class="dropdown-item" href="{{ route('teacher.edit', $teacherItem->id) }}">Editar</a>
                                                                <form action="{{ route('teacher.destroy', $teacherItem->id) }}" method="POST" onsubmit="return confirm('Tem a certeza que deseja eliminar este formador?');">
                                                                    @csrf
                                                                    @method('DELETE')
