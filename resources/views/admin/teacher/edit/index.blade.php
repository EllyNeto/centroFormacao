                                ...
                                <div class="col-xl-3 col-lg-4">
                                    ...
                                    <div class="avatar-upload">
                                        <div class="avatar-preview mb-3">
                                            @if($teacher->image)
                                                <div id="imagePreview" style="background-image: url('{{ asset('img/teacher/'.$teacher->image) }}'); width: 130px; height: 130px; background-size: cover; background-position: center; border-radius: 12px; border: 2px solid #e2e8f0; margin: 0 auto;"></div>
                                            @else
